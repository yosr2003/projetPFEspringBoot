...
import com.projetPfe.Iservice.IAmotissementService;
...
public class AmortissmentEchServiceImpl implements IAmotissementService{
	...
	public ApiResponse alerteEcheance() {
		 try {
	            ...
	            List<AmortissementEch> upcomingDeadlines = amotissementRepo.findUpcomingDeadlines(targetDate);
	            
	            // Convertir les entités en DTOs
//	            List<AmortissementEch> dtos = upcomingDeadlines.stream()
//	                    .map(AmortissementEch::new)
//	                    .collect(Collectors.toList());
	            ...
	            ResponseBodyDTO<List<AmortissementEch>> body = new ResponseBodyDTO<>(upcomingDeadlines);
