...
//	    		("Ce Dossier Délégué a déjà un rapport de mouvement financier");
	    ...
	    StringBuilder xml = genererContenuXml(transferts.stream().map(t -> (Transfert) t).collect(Collectors.toList()));
