	    ...
	    return args -> {
	     ...
	     // 2️⃣ Créer quelques Taux de change
	        ...
	        List<DossierDelegue> dossiers = List.of(
	            ...
	            new DossierDelegue("D003", "2023", EtatDoss.VALIDE, LocalDate.now().minusDays(60), "Problème administratif", "Demande en cours", LocalDateTime.now().minusMonths(12), LocalDate.of(2023, 2, 10), LocalDate.of(2023, 12, 10), LocalDate.of(2024, 1, 10), 2000.0, DossierDelegueType.SCOLARITE, List.of()),
	            new DossierDelegue("D004", "2024", EtatDoss.ANNULE, LocalDate.now().minusDays(30), "Dossier traité", null, LocalDateTime.now().minusMonths(6), LocalDate.of(2024, 1, 5), LocalDate.of(2024, 11, 15), null, 5000.0, DossierDelegueType.CONTRAT_COMMERCIALE, List.of()),
	            ...
	            new DossierDelegue("D006", "2021", EtatDoss.REJETE, LocalDate.now().minusDays(90), "Manque de justificatifs", "Révision en cours", LocalDateTime.now().minusYears(3), LocalDate.of(2021, 4, 14), LocalDate.of(2021, 9, 30), LocalDate.of(2021, 12, 15), 3000.0, DossierDelegueType.EMPREINT_EXTERIEUR, List.of()),
	            new DossierDelegue("D007", "2020", EtatDoss.OUVERT, LocalDate.now().minusDays(180), "Fin du programme", null, LocalDateTime.now().minusYears(4), LocalDate.of(2020, 7, 1), LocalDate.of(2020, 11, 30), null, 8000.0, DossierDelegueType.SCOLARITE, List.of()),
	            ...
	            new DossierDelegue("D010", "2024", EtatDoss.REJETE , LocalDate.now().minusDays(45), "Analyse complémentaire requise", "Documents en attente", LocalDateTime.now().minusMonths(3), LocalDate.of(2024, 2, 20), LocalDate.of(2024, 12, 10), LocalDate.of(2025, 1, 5), 6000.0, DossierDelegueType.SCOLARITE, List.of()),
	            new DossierDelegue("D011", "2022", EtatDoss.CLOTURE, LocalDate.now().minusDays(365), "Dossier terminé", null, LocalDateTime.now().minusYears(2), LocalDate.of(2022, 8, 10), LocalDate.of(2022, 10, 30), null, 2500.0, DossierDelegueType.EMPREINT_EXTERIEUR, List.of())
